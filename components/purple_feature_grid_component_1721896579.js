...
Vue.component("purple_feature_grid_component_1721896579", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Real-Time Ethereum Transaction Monitoring</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our cutting-edge Ethereum transaction monitoring system. Get instant alerts for new transactions as they happen, giving you a competitive edge in the dynamic world of cryptocurrency.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Our advanced transaction analysis tools provide you with comprehensive insights into every aspect of Ethereum transactions, from gas fees to smart contract interactions, enabling you to make informed decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Tailor our notification system to your specific needs. Set up personalized alerts for transaction types, wallet addresses, or any other criteria that matter to your business, ensuring you never miss a beat.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Navigate our intuitive and sleek interface with ease, designed to provide a seamless experience for both novice and experienced users alike. Stay on top of Ethereum transactions without sacrificing convenience.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Advanced Data Visualization</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Gain deeper insights with our powerful data visualization tools. Visualize transaction patterns, trends, and anomalies through interactive charts and graphs, enabling you to make data-driven decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Rest assured that your data is safe with our robust security measures and reliable infrastructure. Our system is designed to handle high volumes of transactions without compromising performance or data integrity.</p></div>
        </div>
    </div>`,
        data() {
            return {
